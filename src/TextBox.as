package
{
	...
	public class TextBox extends Entity
	{
		...
		private function InitCodeKeys():void
		{
			...
			codeKeys[Key.SPACE] = [EnterCode, "_"];
			codeKeys[Key.A] = [EnterCode, "A"];
			codeKeys[Key.B] = [EnterCode, "B"];
			codeKeys[Key.C] = [EnterCode, "C"];
			codeKeys[Key.D] = [EnterCode, "D"];
			codeKeys[Key.E] = [EnterCode, "E"];
			codeKeys[Key.F] = [EnterCode, "F"];
			codeKeys[Key.G] = [EnterCode, "G"];
			codeKeys[Key.H] = [EnterCode, "H"];
			codeKeys[Key.I] = [EnterCode, "I"];
			codeKeys[Key.J] = [EnterCode, "J"];
			codeKeys[Key.K] = [EnterCode, "K"];
			codeKeys[Key.L] = [EnterCode, "L"];
			codeKeys[Key.M] = [EnterCode, "M"];
			codeKeys[Key.N] = [EnterCode, "N"];
			codeKeys[Key.O] = [EnterCode, "O"];
			codeKeys[Key.P] = [EnterCode, "P"];
			codeKeys[Key.Q] = [EnterCode, "Q"];
			codeKeys[Key.R] = [EnterCode, "R"];
			codeKeys[Key.S] = [EnterCode, "S"];
			codeKeys[Key.T] = [EnterCode, "T"];
			codeKeys[Key.U] = [EnterCode, "U"];
			codeKeys[Key.V] = [EnterCode, "V"];
			codeKeys[Key.W] = [EnterCode, "W"];
			codeKeys[Key.X] = [EnterCode, "X"];
			codeKeys[Key.Y] = [EnterCode, "Y"];
			codeKeys[Key.Z] = [EnterCode, "Z"];
		...
		private function UpdateCodeDisplay():void
		{
			...
			{
				codeString = codeString.slice(0, idLength);
			}
		...
		override public function render():void 
		{
			...
			var cursorRect:Rectangle = new Rectangle(
				...
				Text.size, 4);
			var background:Rectangle = new Rectangle (codeDisplayPos.x - 20, codeDisplayPos.y - 5, Text.size * idLength/2, 50);
