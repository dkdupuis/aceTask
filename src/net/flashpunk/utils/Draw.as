package net.flashpunk.utils 
{
	...
	public class Draw 
	{
		...
		public static function linePlus(x1:Number, y1:Number, x2:Number, y2:Number, color:uint = 0xFF000000, alpha:Number = 1, thick:Number = 1):void
		{
            ...
            x1 = (x1 - Draw.world.camera.x)* Draw.world.zoom;
		    y1 =  (y1 - Draw.world.camera.y) * Draw.world.zoom;
			
			x2 = (x2 - Draw.world.camera.x)* Draw.world.zoom;
		    y2 =  (y2 - Draw.world.camera.y) * Draw.world.zoom;
		 ...
		 * // curt edit, global - whether or not to apply the zoom
		 */
		public static function rectPlus(x:Number, y:Number, width:Number, height:Number, global:Boolean = false, color:uint = 0xFFFFFF, alpha:Number = 1, fill:Boolean = true, thick:Number = 1, radius:Number = 0):void
		{
			if (global)
			{
				x = x - _camera.x;
			...
			{
				x = (x - Draw.world.camera.x)* Draw.world.zoom;
				y = (y - Draw.world.camera.y) * Draw.world.zoom;
			}
			...
			if (radius <= 0) {
				...
				_graphics.drawRoundRect(x , y, width, height, radius);
			}
